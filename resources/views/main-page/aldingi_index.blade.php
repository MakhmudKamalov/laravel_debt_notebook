...
<div class="container">
  ...
  <form  method="POST" action="{{ route('login-tekseriw') }}">
    @csrf
    <!-- <img class="mb-4" src="/docs/5.3/assets/brand/bootstrap-logo.svg" alt="" width="72" height="57"> -->
    <h1 class="h3 mb-3 fw-normal">Введите логин и пароль:</h1>

    <div class="form-floating">
      <input type="text" name="login" value="{{ old('login') }}" class="form-control @error('login')
        is-invalid
   ...
   <div class="" style="background-color: aqua; text-align:center">
    <b>login:Max</b><br>
     <b>password:12345</b>
  </div>
  </form>
